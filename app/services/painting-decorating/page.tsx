    ...
    <div className="min-h-screen bg-gray-50 pt-16">
      ...
      <section className="bg-blue-700 text-white py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h1 className="text-5xl font-bold mb-4">Painting & Decorating</h1>
          <p className="text-xl max-w-3xl mx-auto">
            Transform your home with professional painting and decorating services. 
            From color consultation to flawless application, we bring beauty to every surface.
          </p>
        </div>
      </section>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-4xl font-bold text-gray-900 mb-4">Painting Transformations</h2>
            <p className="text-xl text-gray-600">
              See how the right colors and finishes can completely transform any space
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-gray-600 mb-8">
                Whether you need a single room refreshed or your entire home painted, 
                our skilled painters deliver flawless results with premium materials and techniques.
              </p>
      ...
      <section className="bg-blue-700 text-white py-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-4xl font-bold mb-4">Ready to Transform Your Space with Color?</h2>
          <p className="text-xl mb-8">
            Let's discuss your painting and decorating project and bring new life to your home
          </p>
