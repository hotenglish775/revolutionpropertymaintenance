...
export default function BasementFinishing() {
  ...
  const beforeAfterImages = [
    ...
    },
    {
      ...
      title: 'Home Office & Recreation'
    },
    {
      before: 'https://images.pexels.com/photos/5998051/pexels-photo-5998051.jpeg?auto=compress&cs=tinysrgb&w=800&h=500&fit=crop',
      after: 'https://images.pexels.com/photos/1571468/pexels-photo-1571468.jpeg?auto=compress&cs=tinysrgb&w=800&h=500&fit=crop',
    ...
    <div className="min-h-screen bg-gray-50 pt-16">
      ...
      <section className="bg-blue-700 text-white py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h1 className="text-5xl font-bold mb-4">Basement Finishing</h1>
          <p className="text-xl max-w-3xl mx-auto">
            Unlock the potential of your basement space with professional finishing services. 
            Transform unused space into valuable living areas.
          </p>
        </div>
      </section>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-4xl font-bold text-gray-900 mb-4">Basement Transformations</h2>
            <p className="text-xl text-gray-600">
              See how we turn unfinished basements into beautiful, functional living spaces
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-gray-600 mb-8">
                Whether you want a home theater, office, guest suite, or recreation room, 
                we transform your basement into valuable, comfortable living space.
              </p>
      ...
      <section className="bg-blue-700 text-white py-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-4xl font-bold mb-4">Ready to Finish Your Basement?</h2>
          <p className="text-xl mb-8">
            Let's discuss your basement finishing project and maximize your home's potential
          </p>
