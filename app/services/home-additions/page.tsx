    ...
    <div className="min-h-screen bg-gray-50 pt-16">
      ...
      <section className="bg-blue-700 text-white py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h1 className="text-5xl font-bold mb-4">Home Additions</h1>
          <p className="text-xl max-w-3xl mx-auto">
            Expand your living space with seamless home additions that blend perfectly 
            with your existing architecture and enhance your home's value.
          </p>
        </div>
      </section>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-4xl font-bold text-gray-900 mb-4">Addition Transformations</h2>
            <p className="text-xl text-gray-600">
              See how we seamlessly expand homes while maintaining architectural integrity
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-gray-600 mb-8">
                From single rooms to multi-story extensions, we design and build additions 
                that seamlessly integrate with your existing home while meeting your family's needs.
              </p>
      ...
      <section className="bg-blue-700 text-white py-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-4xl font-bold mb-4">Ready to Expand Your Home?</h2>
          <p className="text-xl mb-8">
            Let's discuss your home addition project and create the extra space you need
          </p>
