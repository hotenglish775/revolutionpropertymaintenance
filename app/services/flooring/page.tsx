  ...
  const beforeAfterImages = [
    {
      ...
      after: 'https://images.pexels.com/photos/1571460/pexels-photo-1571460.jpeg?auto=compress&cs=tinysrgb&w=800&h=500&fit=crop',
    ...
    },
    {
      ...
      after: 'https://images.pexels.com/photos/1571461/pexels-photo-1571461.jpeg?auto=compress&cs=tinysrgb&w=800&h=500&fit=crop',
    ...
    },
    {
      ...
      after: 'https://images.pexels.com/photos/1571453/pexels-photo-1571453.jpeg?auto=compress&cs=tinysrgb&w=800&h=500&fit=crop',
    ...
    <div className="min-h-screen bg-gray-50 pt-16">
      ...
      <section className="bg-blue-700 text-white py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h1 className="text-5xl font-bold mb-4">Flooring Services</h1>
          <p className="text-xl max-w-3xl mx-auto">
            Transform your home from the ground up with professional flooring installation. 
            From hardwood to luxury vinyl, we install floors that last.
          </p>
        </div>
      </section>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-4xl font-bold text-gray-900 mb-4">Flooring Transformations</h2>
            <p className="text-xl text-gray-600">
              See how new flooring can completely transform the look and feel of any room
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-gray-600 mb-8">
                Whether you're looking for the warmth of hardwood, the durability of luxury vinyl, 
                or the elegance of tile, we install quality flooring that enhances your home.
              </p>
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              />
              <img 
                src="https://images.pexels.com/photos/1571461/pexels-photo-1571461.jpeg?auto=compress&cs=tinysrgb&w=400&h=300&fit=crop"
      ...
      <section className="bg-blue-700 text-white py-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-4xl font-bold mb-4">Ready to Upgrade Your Floors?</h2>
          <p className="text-xl mb-8">
            Let's discuss your flooring project and find the perfect solution for your home
          </p>
